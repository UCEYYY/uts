                ...
                <div class="card-body">
                    <form action="{{ route('books.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('tahun_terbit') is-invalid @enderror" id="tahun_terbit" name="tahun_terbit" value="{{ old('tahun_terbit') }}" min="1945" required>
                            @error('tahun_terbit')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
